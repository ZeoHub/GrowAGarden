...
local eggChances = {
    ...
    ["Dinosaur Egg"] = {["Raptor"] = 40, ["Triceratops"] = 30, ["Stegosaurus"] = 30},
    ["Primal Egg"] = {["Parasaurolophus"] = 30, ["Iguanodon"] = 25, ["Pachycephalosaurus"] = 25, ["Dilophosaurus"] = 20},
}
...
local function makeStyledButton(parent, text, yPos, color, hover)
    ...
    btn.Size = UDim2.new(0.9, 0, 0, 36)  -- Increased height
...
-- Main frame enlarged by 15%
local mainFrame = Instance.new("Frame")
mainFrame.Size = UDim2.new(0, 300, 0, 180)  -- Increased size
mainFrame.Position = UDim2.new(0.5, -150, 0.5, -90)  -- Centered
mainFrame.BackgroundColor3 = BROWN_BG
mainFrame.Parent = gui
mainFrame.Active = true
mainFrame.Draggable = true
local frameCorner = Instance.new("UICorner", mainFrame)
frameCorner.CornerRadius = UDim.new(0, 12)  -- Larger radius
...
topBar.Size = UDim2.new(1, 0, 0, 36)  -- Increased height
...
topLabel.Size = UDim2.new(1, -80, 1, 0)  -- Adjusted width
topLabel.Position = UDim2.new(0, 12, 0, 0)  -- Increased padding
...
infoBtn.Size = UDim2.new(0, 24, 0, 24)  -- Larger button
infoBtn.Position = UDim2.new(1, -60, 0.5, -12)  -- Adjusted position
...
closeBtn.Size = UDim2.new(0, 24, 0, 24)  -- Larger button
...
contentFrame.Size = UDim2.new(1, -12, 1, -44)  -- Increased padding
contentFrame.Position = UDim2.new(0, 6, 0, 40)  -- Adjusted position
contentFrame.BackgroundTransparency = 1
contentFrame.ZIndex = 2
contentFrame.Parent = mainFrame

local statusLabel = Instance.new("TextLabel")
statusLabel.Size = UDim2.new(0.9, 0, 0, 26)  -- Increased height
statusLabel.Position = UDim2.new(0.05, 0, 0, 8)  -- Added padding
...
local toggleBtn = makeStyledButton(contentFrame, "Toggle ESP (ON)", 40, BUTTON_GREEN, BUTTON_GREEN_HOVER)
local rerollBtn = makeStyledButton(contentFrame, "Reroll Pets", 84, BUTTON_BLUE, BUTTON_BLUE_HOVER)
...
infoBtn.MouseButton1Click:Connect(function()
    ...
    modal.Size = UDim2.new(0, 280, 0, 150)  -- Increased size
    modal.Position = UDim2.new(0.5, -140, 0.5, -75)  -- Centered
    modal.BackgroundColor3 = BROWN_LIGHT
    modal.Active = true
    modal.ZIndex = 30
    modal.Parent = gui
    local modalCorner = Instance.new("UICorner", modal)
    modalCorner.CornerRadius = UDim.new(0, 12)  -- Larger radius
    ...
    textTile.Size = UDim2.new(1, 0, 0, 26)  -- Increased height
    ...
    textTileCorner.CornerRadius = UDim.new(0, 12)

    local textTileLabel = Instance.new("TextLabel")
    textTileLabel.Size = UDim2.new(1, -24, 1, 0)  -- Adjusted width
    textTileLabel.Position = UDim2.new(0, 12, 0, 0)  -- Increased padding
    ...
    closeBtn2.Size = UDim2.new(0, 22, 0, 22)  -- Larger button
    closeBtn2.Position = UDim2.new(1, -28, 0.5, -11)  -- Adjusted position
    ...
    infoBox.Size = UDim2.new(1, -12, 1, -32)  -- Adjusted size
    infoBox.Position = UDim2.new(0, 6, 0, 28)  -- Adjusted position
    ...
    infoBoxCorner.CornerRadius = UDim.new(0, 8)  -- Larger radius
    ...
    infoLabel.Size = UDim2.new(1, -8, 1, -8)  -- Added padding
